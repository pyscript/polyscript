...
Once the new version of `polyscript` lands on *npm*, it is possible to move forward with a new [PyScript Maintenance Release](https://github.com/pyscript/pyscript/blob/main/core/MAINTENANCE.md).
